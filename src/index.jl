...
function index_page()
    ...
    return DOM.div(
        ...
        Section(bg="white",
            DOM.div("Users"; class="text-lg text-black flex justify-center mt-10 mb-6"),
            FlexGrid(
            ...
            DOM.div("Supporters"; class="text-lg text-black flex justify-center mt-10 mb-6"),
            FlexGrid(
            ...
            DOM.div("Follow us"; class="text-lg text-black flex justify-center mt-10 mb-6"),
            FlexGrid(
